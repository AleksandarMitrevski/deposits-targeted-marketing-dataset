...
output = open("evaluate_rf.txt", "w")

SELECTED_HYPERPARAM_VALUE = 150
...
X_test = X_train
Y_test = Y_train
classifier = RandomForestClassifier(n_estimators=SELECTED_HYPERPARAM_VALUE, max_depth=16, min_samples_split=22, min_samples_leaf=10)
...
classifier = RandomForestClassifier(n_estimators=SELECTED_HYPERPARAM_VALUE, max_depth=20, min_samples_split=22, min_samples_leaf=10)
classifier.fit(X_train, Y_train)
predictions = classifier.predict(X_test)
