...
output = open("evaluate_gbdt.txt", "w")

SELECTED_HYPERPARAM_VALUE_FIRST = 150
SELECTED_HYPERPARAM_VALUE_SECOND = 0.1
...
X_test = X_train
Y_test = Y_train
classifier = GradientBoostingClassifier(n_estimators=SELECTED_HYPERPARAM_VALUE_FIRST, learning_rate=SELECTED_HYPERPARAM_VALUE_SECOND)
